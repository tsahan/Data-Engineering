...
def process_song_file(cur, filepath):
    """
    Load all song records into song table and all artist records into artists table.
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    Process song logs to analyze listening patterns of the users.
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def main():
    """
    Make db connection and call other functions.
    """
